...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.patient_exit_date'
        db.add_column('facturation_invoice', 'patient_exit_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Invoice.patient_entry_date'
        db.add_column('facturation_invoice', 'patient_entry_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Invoice.patient_exit_date'
        db.delete_column('facturation_invoice', 'patient_exit_date')

        # Deleting field 'Invoice.patient_entry_date'
        db.delete_column('facturation_invoice', 'patient_entry_date')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 13, 22, 11, 59, 549574)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 13, 22, 11, 59, 549416)'}),
