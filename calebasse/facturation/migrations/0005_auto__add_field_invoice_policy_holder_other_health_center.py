...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.policy_holder_other_health_center'
        db.add_column('facturation_invoice', 'policy_holder_other_health_center', self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Invoice.policy_holder_other_health_center'
        db.delete_column('facturation_invoice', 'policy_holder_other_health_center')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 15, 0, 33, 1, 950345)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 15, 0, 33, 1, 950244)'}),
