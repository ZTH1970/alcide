...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoicing.service'
        db.alter_column(u'facturation_invoicing', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.Service'], on_delete=models.PROTECT))

        # Changing field 'Invoice.invoicing'
        db.alter_column(u'facturation_invoice', 'invoicing_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['facturation.Invoicing'], on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'Invoicing.service'
        db.alter_column(u'facturation_invoicing', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.Service']))

        # Changing field 'Invoice.invoicing'
        db.alter_column(u'facturation_invoice', 'invoicing_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['facturation.Invoicing']))
    ...
    models = {
        ...
        u'facturation.invoice': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoicing': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['facturation.Invoicing']", 'on_delete': 'models.PROTECT'}),
        ...
        u'facturation.invoicing': {
            ...
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ressources.Service']", 'on_delete': 'models.PROTECT'}),
            'start_date': ('django.db.models.fields.DateField', [], {}),
