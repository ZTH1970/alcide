...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.policy_holder_management_code'
        db.add_column(u'facturation_invoice', 'policy_holder_management_code', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True), keep_default=False)

        # Adding field 'Invoice.policy_holder_management_code_name'
        db.add_column(u'facturation_invoice', 'policy_holder_management_code_name', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Invoice.policy_holder_management_code'
        db.delete_column(u'facturation_invoice', 'policy_holder_management_code')

        # Deleting field 'Invoice.policy_holder_management_code_name'
        db.delete_column(u'facturation_invoice', 'policy_holder_management_code_name')
    ...
    models = {
        u'actes.act': {
            ...
            'last_validation_state': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'to': "orm['actes.ActValidationState']"}),
            'old_id': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'parent_event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['agenda.Event']", 'null': 'True', 'blank': 'True'}),
            ...
            'transport_company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ressources.TransportCompany']", 'null': 'True', 'blank': 'True'}),
            'transport_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ressources.TransportType']", 'null': 'True', 'blank': 'True'}),
        ...
        'actes.actvalidationstate': {
            'Meta': {'object_name': 'ActValidationState'},
        ...
        u'agenda.event': {
            ...
            'room': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ressources.Room']", 'null': 'True', 'blank': 'True'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 8, 15, 13, 2, 604543)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 8, 15, 13, 2, 604202)'}),
        ...
        u'dossiers.patientcontact': {
            'Meta': {'object_name': 'PatientContact', '_ormbases': [u'personnes.People']},
        ...
        u'dossiers.patientrecord': {
            ...
            'policyholder': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['dossiers.PatientContact']"}),
        ...
        u'facturation.invoice': {
            'Meta': {'object_name': 'Invoice'},
            'acts': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['actes.Act']", 'symmetrical': 'False'}),
            'amount': ('django.db.models.fields.IntegerField', [], {}),
            'batch': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoicing': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['facturation.Invoicing']"}),
            'number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'patient_birthdate': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'patient_entry_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'patient_exit_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'patient_first_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'blank': 'True'}),
            'patient_healthcenter': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'related_by_patient_invoices'", 'null': 'True', 'to': u"orm['ressources.HealthCenter']"}),
            'patient_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'patient_last_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'blank': 'True'}),
            'patient_other_health_center': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '4', 'blank': 'True'}),
            'patient_social_security_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '13', 'blank': 'True'}),
            'patient_twinning_rank': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'policy_holder_address': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'blank': 'True'}),
            'policy_holder_first_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'blank': 'True'}),
            'policy_holder_healthcenter': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'related_by_policy_holder_invoices'", 'null': 'True', 'to': u"orm['ressources.HealthCenter']"}),
            'policy_holder_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'policy_holder_last_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'blank': 'True'}),
            'policy_holder_management_code': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'blank': 'True'}),
            'policy_holder_management_code_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256', 'blank': 'True'}),
            'policy_holder_other_health_center': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '4', 'blank': 'True'}),
            'policy_holder_social_security_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '13', 'blank': 'True'}),
            'ppa': ('django.db.models.fields.IntegerField', [], {}),
            'rejected': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'})
        },
        u'facturation.invoicing': {
            ...
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ressources.Service']"}),
            'start_date': ('django.db.models.fields.DateField', [], {}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'open'", 'max_length': '20'})
        },
        u'personnes.externaltherapist': {
            'Meta': {'object_name': 'ExternalTherapist', '_ormbases': [u'personnes.People']},
        ...
        u'personnes.externalworker': {
            'Meta': {'object_name': 'ExternalWorker', '_ormbases': [u'personnes.People']},
            'address': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '120', 'null': 'True', 'blank': 'True'}),
            'address_complement': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '120', 'null': 'True', 'blank': 'True'}),
            'city': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '80', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        u'personnes.worker': {
            'Meta': {'object_name': 'Worker', '_ormbases': [u'personnes.People']},
