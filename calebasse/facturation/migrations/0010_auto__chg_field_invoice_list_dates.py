...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.list_dates'
        db.alter_column(u'facturation_invoice', 'list_dates', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

    def backwards(self, orm):

        # Changing field 'Invoice.list_dates'
        db.alter_column(u'facturation_invoice', 'list_dates', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
    ...
    models = {
        ...
        u'facturation.invoice': {
            ...
            'list_dates': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'null': 'True', 'blank': 'True'}),
