...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Invoice.patient'
        db.delete_column('facturation_invoice', 'patient_id')

        # Adding field 'Invoice.patient_other_health_center'
        ...
        # Adding field 'Invoice.patient_birthdate'
        db.add_column('facturation_invoice', 'patient_birthdate', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Invoice.policy_holder_healthcenter'
        ...
        # Adding field 'Invoice.patient_social_security_id'
        db.add_column('facturation_invoice', 'patient_social_security_id', self.gf('django.db.models.fields.CharField')(max_length=13, null=True, blank=True), keep_default=False)

        # Adding field 'Invoice.patient_id'
        db.add_column('facturation_invoice', 'patient_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Invoice.patient_first_name'
        db.add_column('facturation_invoice', 'patient_first_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Invoice.policy_holder_id'
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 12, 16, 4, 43, 62133)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 12, 16, 4, 43, 61978)'}),
        ...
        'facturation.invoice': {
            ...
            'patient_first_name': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            ...
            'patient_last_name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'patient_other_health_center': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'patient_social_security_id': ('django.db.models.fields.CharField', [], {'max_length': '13', 'null': 'True', 'blank': 'True'}),
            'patient_twinning_rank': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'policy_holder_first_name': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            ...
            'policy_holder_last_name': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'policy_holder_social_security_id': ('django.db.models.fields.CharField', [], {'max_length': '13', 'blank': 'True'}),
