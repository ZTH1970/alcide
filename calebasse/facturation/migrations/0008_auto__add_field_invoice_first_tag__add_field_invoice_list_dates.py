...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.first_tag'
        db.add_column(u'facturation_invoice', 'first_tag', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Invoice.list_dates'
        db.add_column(u'facturation_invoice', 'list_dates', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Invoice.first_tag'
        db.delete_column(u'facturation_invoice', 'first_tag')

        # Deleting field 'Invoice.list_dates'
        db.delete_column(u'facturation_invoice', 'list_dates')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 22, 17, 15, 13, 204879)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 22, 17, 15, 13, 204543)'}),
        ...
        u'facturation.invoice': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'first_tag': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoicing': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['facturation.Invoicing']"}),
            'list_dates': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
