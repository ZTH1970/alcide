...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.policy_holder_address'
        db.add_column('facturation_invoice', 'policy_holder_address', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Changing field 'Invoice.patient_other_health_center'
        db.alter_column('facturation_invoice', 'patient_other_health_center', self.gf('django.db.models.fields.CharField')(max_length=4, blank=True))

        # Changing field 'Invoice.patient_last_name'
        db.alter_column('facturation_invoice', 'patient_last_name', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True))

        # Changing field 'Invoice.patient_social_security_id'
        db.alter_column('facturation_invoice', 'patient_social_security_id', self.gf('django.db.models.fields.CharField')(max_length=13, blank=True))

        # Changing field 'Invoice.patient_first_name'
        db.alter_column('facturation_invoice', 'patient_first_name', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Invoice.policy_holder_address'
        db.delete_column('facturation_invoice', 'policy_holder_address')

        # Changing field 'Invoice.patient_other_health_center'
        db.alter_column('facturation_invoice', 'patient_other_health_center', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True))

        # Changing field 'Invoice.patient_last_name'
        db.alter_column('facturation_invoice', 'patient_last_name', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Invoice.patient_social_security_id'
        db.alter_column('facturation_invoice', 'patient_social_security_id', self.gf('django.db.models.fields.CharField')(max_length=13, null=True, blank=True))

        # Changing field 'Invoice.patient_first_name'
        db.alter_column('facturation_invoice', 'patient_first_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 13, 12, 10, 51, 682912)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 13, 12, 10, 51, 682756)'}),
        ...
        'facturation.invoice': {
            ...
            'patient_healthcenter': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'related_by_patient_invoices'", 'null': 'True', 'to': "orm['ressources.HealthCenter']"}),
            ...
            'policy_holder_healthcenter': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'related_by_policy_holder_invoices'", 'null': 'True', 'to': "orm['ressources.HealthCenter']"}),
