...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TransportPrescriptionLog'
        db.create_table(u'dossiers_transportprescriptionlog', (
            ('choices', self.gf('django.db.models.fields.CharField')(max_length=4096, null=True, blank=True)),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dossiers.PatientRecord'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'dossiers', ['TransportPrescriptionLog'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'TransportPrescriptionLog'
        db.delete_table(u'dossiers_transportprescriptionlog')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 15, 16, 41, 24, 421945)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 15, 16, 41, 24, 421494)'}),
