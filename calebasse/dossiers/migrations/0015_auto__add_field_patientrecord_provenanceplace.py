...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PatientRecord.provenanceplace'
        db.add_column(u'dossiers_patientrecord', 'provenanceplace',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ressources.ProvenancePlace'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PatientRecord.provenanceplace'
        db.delete_column(u'dossiers_patientrecord', 'provenanceplace_id')
