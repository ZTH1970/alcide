...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PatientAddress.recipient'
        db.add_column(u'dossiers_patientaddress', 'recipient',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PatientAddress.recipient'
        db.delete_column(u'dossiers_patientaddress', 'recipient')
