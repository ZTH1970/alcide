...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PatientRecord.addresses_contacts_comment'
        db.add_column(u'dossiers_patientrecord', 'addresses_contacts_comment',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PatientRecord.addresses_contacts_comment'
        db.delete_column(u'dossiers_patientrecord', 'addresses_contacts_comment')
    ...
    models = {
        ...
        u'dossiers.patientrecord': {
            ...
            'addresses_contacts_comment': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
