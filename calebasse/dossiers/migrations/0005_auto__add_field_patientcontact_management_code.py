...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PatientContact.management_code'
        db.add_column(u'dossiers_patientcontact', 'management_code', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.ManagementCode'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'PatientContact.management_code'
        db.delete_column(u'dossiers_patientcontact', 'management_code_id')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 12, 17, 56, 406984)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 12, 17, 56, 406650)'}),
