...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProtectionState'
        db.create_table(u'dossiers_protectionstate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dossiers.PatientRecord'])),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dossiers.ProtectionStatus'])),
        ...
        db.send_create_signal('dossiers', ['ProtectionState'])

        # Adding model 'ProtectionStatus'
        db.create_table(u'dossiers_protectionstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal('dossiers', ['ProtectionStatus'])


    def backwards(self, orm):
        # Deleting model 'ProtectionState'
        db.delete_table(u'dossiers_protectionstate')

        # Deleting model 'ProtectionStatus'
        db.delete_table(u'dossiers_protectionstatus')
