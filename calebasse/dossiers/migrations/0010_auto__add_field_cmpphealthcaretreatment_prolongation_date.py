...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CmppHealthCareTreatment.prolongation_date'
        db.add_column(u'dossiers_cmpphealthcaretreatment', 'prolongation_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CmppHealthCareTreatment.prolongation_date'
        db.delete_column(u'dossiers_cmpphealthcaretreatment', 'prolongation_date')
