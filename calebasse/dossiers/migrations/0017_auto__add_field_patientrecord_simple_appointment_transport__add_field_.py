...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PatientRecord.simple_appointment_transport'
        db.add_column(u'dossiers_patientrecord', 'simple_appointment_transport',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PatientRecord.periodic_appointment_transport'
        db.add_column(u'dossiers_patientrecord', 'periodic_appointment_transport',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PatientRecord.simple_appointment_transport'
        db.delete_column(u'dossiers_patientrecord', 'simple_appointment_transport')

        # Deleting field 'PatientRecord.periodic_appointment_transport'
        db.delete_column(u'dossiers_patientrecord', 'periodic_appointment_transport')
    ...
    models = {
        ...
        u'dossiers.patientrecord': {
            ...
            'periodic_appointment_transport': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'simple_appointment_transport': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'dossiers.protectionstate': {
            'Meta': {'ordering': "['-start_date']", 'object_name': 'ProtectionState'},
            'comment': ('django.db.models.fields.TextField', [], {'max_length': '3000', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dossiers.ProtectionStatus']"})
        },
        'dossiers.protectionstatus': {
            'Meta': {'object_name': 'ProtectionStatus'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
