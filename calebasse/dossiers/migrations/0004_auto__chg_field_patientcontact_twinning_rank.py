...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PatientContact.twinning_rank'
        db.alter_column('dossiers_patientcontact', 'twinning_rank', self.gf('django.db.models.fields.IntegerField')())
    
    
    def backwards(self, orm):
        
        # Changing field 'PatientContact.twinning_rank'
        db.alter_column('dossiers_patientcontact', 'twinning_rank', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 7, 11, 31, 22, 824241)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 7, 11, 31, 22, 824171)'}),
