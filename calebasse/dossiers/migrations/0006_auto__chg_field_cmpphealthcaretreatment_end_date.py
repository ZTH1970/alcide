...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CmppHealthCareTreatment.end_date'
        db.alter_column(u'dossiers_cmpphealthcaretreatment', 'end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'CmppHealthCareTreatment.end_date'
        db.alter_column(u'dossiers_cmpphealthcaretreatment', 'end_date', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 12, 10, 46, 23, 382606)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 12, 10, 46, 23, 382276)'}),
