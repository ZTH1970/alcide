...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PatientRecord.deficiency_intellectual'
        db.add_column(u'dossiers_patientrecord', 'deficiency_intellectual',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'PatientRecord.deficiency_autism_and_other_ted'
        db.add_column(u'dossiers_patientrecord', 'deficiency_autism_and_other_ted',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'PatientRecord.deficiency_mental_disorder'
        db.add_column(u'dossiers_patientrecord', 'deficiency_mental_disorder',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'PatientRecord.deficiency_learning_disorder'
        db.add_column(u'dossiers_patientrecord', 'deficiency_learning_disorder',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'PatientRecord.deficiency_auditory'
        db.add_column(u'dossiers_patientrecord', 'deficiency_auditory',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'PatientRecord.deficiency_visual'
        db.add_column(u'dossiers_patientrecord', 'deficiency_visual',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'PatientRecord.deficiency_motor'
        db.add_column(u'dossiers_patientrecord', 'deficiency_motor',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'PatientRecord.deficiency_metabolic_disorder'
        db.add_column(u'dossiers_patientrecord', 'deficiency_metabolic_disorder',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'PatientRecord.deficiency_brain_damage'
        db.add_column(u'dossiers_patientrecord', 'deficiency_brain_damage',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'PatientRecord.deficiency_polyhandicap'
        db.add_column(u'dossiers_patientrecord', 'deficiency_polyhandicap',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PatientRecord.deficiency_behavioral_disorder'
        db.add_column(u'dossiers_patientrecord', 'deficiency_behavioral_disorder',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'PatientRecord.deficiency_in_diagnostic'
        db.add_column(u'dossiers_patientrecord', 'deficiency_in_diagnostic',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PatientRecord.deficiency_other_disorder'
        db.add_column(u'dossiers_patientrecord', 'deficiency_other_disorder',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PatientRecord.deficiency_intellectual'
        db.delete_column(u'dossiers_patientrecord', 'deficiency_intellectual')

        # Deleting field 'PatientRecord.deficiency_autism_and_other_ted'
        db.delete_column(u'dossiers_patientrecord', 'deficiency_autism_and_other_ted')

        # Deleting field 'PatientRecord.deficiency_mental_disorder'
        db.delete_column(u'dossiers_patientrecord', 'deficiency_mental_disorder')

        # Deleting field 'PatientRecord.deficiency_learning_disorder'
        db.delete_column(u'dossiers_patientrecord', 'deficiency_learning_disorder')

        # Deleting field 'PatientRecord.deficiency_auditory'
        db.delete_column(u'dossiers_patientrecord', 'deficiency_auditory')

        # Deleting field 'PatientRecord.deficiency_visual'
        db.delete_column(u'dossiers_patientrecord', 'deficiency_visual')

        # Deleting field 'PatientRecord.deficiency_motor'
        db.delete_column(u'dossiers_patientrecord', 'deficiency_motor')

        # Deleting field 'PatientRecord.deficiency_metabolic_disorder'
        db.delete_column(u'dossiers_patientrecord', 'deficiency_metabolic_disorder')

        # Deleting field 'PatientRecord.deficiency_brain_damage'
        db.delete_column(u'dossiers_patientrecord', 'deficiency_brain_damage')

        # Deleting field 'PatientRecord.deficiency_polyhandicap'
        db.delete_column(u'dossiers_patientrecord', 'deficiency_polyhandicap')

        # Deleting field 'PatientRecord.deficiency_behavioral_disorder'
        db.delete_column(u'dossiers_patientrecord', 'deficiency_behavioral_disorder')

        # Deleting field 'PatientRecord.deficiency_in_diagnostic'
        db.delete_column(u'dossiers_patientrecord', 'deficiency_in_diagnostic')

        # Deleting field 'PatientRecord.deficiency_other_disorder'
        db.delete_column(u'dossiers_patientrecord', 'deficiency_other_disorder')
    ...
    models = {
        ...
        'dossiers.cmpphealthcaretreatment': {
            ...
            'prolongation_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'})
        },
        'dossiers.filestate': {
