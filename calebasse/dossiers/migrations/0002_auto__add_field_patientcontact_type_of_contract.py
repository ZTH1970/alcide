...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PatientContact.type_of_contract'
        db.add_column('dossiers_patientcontact', 'type_of_contract', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'PatientContact.type_of_contract'
        db.delete_column('dossiers_patientcontact', 'type_of_contract')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 13, 16, 39, 23, 948093)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 13, 16, 39, 23, 948005)'}),
