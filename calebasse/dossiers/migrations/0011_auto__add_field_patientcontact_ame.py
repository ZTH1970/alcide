...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PatientContact.ame'
        db.add_column(u'dossiers_patientcontact', 'ame',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PatientContact.ame'
        db.delete_column(u'dossiers_patientcontact', 'ame')
