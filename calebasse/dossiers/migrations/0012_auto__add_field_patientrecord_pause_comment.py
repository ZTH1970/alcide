...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PatientRecord.pause_comment'
        db.add_column(u'dossiers_patientrecord', 'pause_comment',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PatientRecord.pause_comment'
        db.delete_column(u'dossiers_patientrecord', 'pause_comment')
