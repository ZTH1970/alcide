...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CmppHealthCareDiagnostic.end_date'
        db.add_column(u'dossiers_cmpphealthcarediagnostic', 'end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CmppHealthCareDiagnostic.end_date'
        db.delete_column(u'dossiers_cmpphealthcarediagnostic', 'end_date')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 30, 15, 11, 35, 516251)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 30, 15, 11, 35, 515890)'}),
