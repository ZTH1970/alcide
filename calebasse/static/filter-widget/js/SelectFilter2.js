...
var SelectFilter = {
	...
	var clear_filter_input = quickElement('img', filter_p, '', 'class', 'clear-input-button', 'src', '/static/filter-widget/img/poubelle.png');
        ...
        add_link.className = 'selector-add icon-circle-arrow-right';
        ...
        remove_link.className = 'selector-remove icon-circle-arrow-left';
        ...
        addEvent(clear_filter_input, 'click', function () { 
                filter_input.value = '';
                SelectFilter.filter_key_up({ 'which': null }, field_id);
                return true;
        });
