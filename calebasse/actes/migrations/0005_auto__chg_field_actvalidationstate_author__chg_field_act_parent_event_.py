...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActValidationState.author'
        db.alter_column(u'actes_actvalidationstate', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Act.parent_event'
        db.alter_column(u'actes_act', 'parent_event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agenda.Event'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Act.transport_type'
        db.alter_column(u'actes_act', 'transport_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.TransportType'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Act.transport_company'
        db.alter_column(u'actes_act', 'transport_company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.TransportCompany'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Act.healthcare'
        db.alter_column(u'actes_act', 'healthcare_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dossiers.HealthCare'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Act.last_validation_state'
        db.alter_column(u'actes_act', 'last_validation_state_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['actes.ActValidationState']))

    def backwards(self, orm):

        # Changing field 'ActValidationState.author'
        db.alter_column(u'actes_actvalidationstate', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Act.parent_event'
        db.alter_column(u'actes_act', 'parent_event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agenda.Event'], null=True))

        # Changing field 'Act.transport_type'
        db.alter_column(u'actes_act', 'transport_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.TransportType'], null=True))

        # Changing field 'Act.transport_company'
        db.alter_column(u'actes_act', 'transport_company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.TransportCompany'], null=True))

        # Changing field 'Act.healthcare'
        db.alter_column(u'actes_act', 'healthcare_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dossiers.HealthCare'], null=True))

        # Changing field 'Act.last_validation_state'
        db.alter_column(u'actes_act', 'last_validation_state_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['actes.ActValidationState']))
