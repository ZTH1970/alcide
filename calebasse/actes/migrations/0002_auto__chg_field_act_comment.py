...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Act.comment'
        db.alter_column('actes_act', 'comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Act.comment'
        db.alter_column('actes_act', 'comment', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 5, 14, 56, 59, 247276)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 5, 14, 56, 59, 247210)'}),
