...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Act.last_validation_state'
        db.add_column('actes_act', 'last_validation_state', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['actes.ActValidationState']), keep_default=False)

    
    def backwards(self, orm):
        
        # Deleting field 'Act.last_validation_state'
        db.delete_column('actes_act', 'last_validation_state_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 29, 12, 35, 30, 283745)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 29, 12, 35, 30, 283679)'}),
