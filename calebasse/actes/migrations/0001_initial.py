...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ActValidationState'
        db.create_table('actes_actvalidationstate', (
            ('state_name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('auto', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('previous_state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['actes.ActValidationState'], null=True, blank=True)),
            ('act', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['actes.Act'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('actes', ['ActValidationState'])

        # Adding model 'Act'
        db.create_table('actes_act', (
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('valide', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ...
            ('is_billed', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('healthcare', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dossiers.HealthCare'], null=True, blank=True)),
            ('attendance', self.gf('django.db.models.fields.CharField')(default='absent', max_length=16)),
            ('switch_billable', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('parent_event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agenda.Event'], null=True, blank=True)),
            ('is_lost', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('old_id', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('pause', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('transport_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.TransportType'], null=True, blank=True)),
            ('transport_company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.TransportCompany'], null=True, blank=True)),
            ('time', self.gf('django.db.models.fields.TimeField')(default=datetime.time(0, 0), null=True, db_index=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')(db_index=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_duration', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('validation_locked', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
        ))
        db.send_create_signal('actes', ['Act'])

        # Adding M2M table for field doctors on 'Act'
        db.create_table('actes_act_doctors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('act', models.ForeignKey(orm['actes.act'], null=False)),
            ('worker', models.ForeignKey(orm['personnes.worker'], null=False))
        ))
        db.create_unique('actes_act_doctors', ['act_id', 'worker_id'])

        # Adding model 'ValidationMessage'
        db.create_table('actes_validationmessage', (
            ...
            ('validation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('actes', ['ValidationMessage'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'ActValidationState'
        db.delete_table('actes_actvalidationstate')

        # Deleting model 'Act'
        db.delete_table('actes_act')

        # Removing M2M table for field doctors on 'Act'
        db.delete_table('actes_act_doctors')

        # Deleting model 'ValidationMessage'
        db.delete_table('actes_validationmessage')
    ...
    models = {
        ...
        'actes.actvalidationstate': {
            ...
            'act': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['actes.Act']"}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 5, 14, 55, 44, 671434)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 5, 14, 55, 44, 671367)'}),
