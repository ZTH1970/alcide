...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('personnes_holiday_services')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('holiday', models.ForeignKey(orm['personnes.holiday'], null=False)),
            ('service', models.ForeignKey(orm['ressources.service'], null=False))
        ))
        db.create_unique(m2m_table_name, ['holiday_id', 'service_id'])

        for obj in orm.Holiday.objects.all():
            if obj.service:
    ...
    def backwards(self, orm):
        # Removing M2M table for field services on 'Holiday'
        db.delete_table(db.shorten_name('personnes_holiday_services'))
    ...
    models = {
        ...
        'personnes.holiday': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'new_services'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['ressources.Service']"}),
