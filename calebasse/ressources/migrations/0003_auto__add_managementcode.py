...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ManagementCode'
        db.create_table(u'ressources_managementcode', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_id', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal(u'ressources', ['ManagementCode'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'ManagementCode'
        db.delete_table(u'ressources_managementcode')
