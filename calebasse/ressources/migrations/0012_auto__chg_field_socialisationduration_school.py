...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SocialisationDuration.school'
        db.alter_column(u'ressources_socialisationduration', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.School'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'SocialisationDuration.school'
        db.alter_column(u'ressources_socialisationduration', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.School'], null=True))
