...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SocialisationDuration.level'
        db.alter_column(u'ressources_socialisationduration', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.SchoolLevel'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'SocialisationDuration.level'
        db.alter_column(u'ressources_socialisationduration', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.SchoolLevel'], null=True))
    ...
    models = {
        ...
        u'ressources.socialisationduration': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ressources.SchoolLevel']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'redoublement': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'school': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ressources.School']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {})
        },
