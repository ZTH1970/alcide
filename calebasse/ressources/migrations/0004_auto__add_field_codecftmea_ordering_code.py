...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CodeCFTMEA.ordering_code'
        db.add_column(u'ressources_codecftmea', 'ordering_code', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CodeCFTMEA.ordering_code'
        db.delete_column(u'ressources_codecftmea', 'ordering_code')
