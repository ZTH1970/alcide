...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'agenda_event', 'ressource_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.Ressource'], null=True))

    def backwards(self, orm):
        # Adding field 'Event.ressource_id'
        db.alter_column(u'agenda_event', 'ressource_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.Room'], null=True))
    ...
    models = {
        u'agenda.event': {
            ...
            'ressource_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ressources.Ressource']", 'null': 'True', 'blank': 'True'}),
