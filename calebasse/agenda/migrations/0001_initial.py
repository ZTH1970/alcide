...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'agenda_eventtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('rank', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
        ))
        db.send_create_signal(u'agenda', ['EventType'])

        # Adding model 'Event'
        db.create_table(u'agenda_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=100, null=True, blank=True)),
            ('event_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agenda.EventType'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.Room'], null=True, blank=True)),
            ...
            ('old_ev_id', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('old_rr_id', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('old_rs_id', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('exception_to', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exceptions', null=True, to=orm['agenda.Event'])),
            ('exception_date', self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True)),
            ('canceled', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('recurrence_periodicity', self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True, db_index=True, blank=True)),
            ('recurrence_week_day', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True)),
            ('recurrence_week_offset', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True)),
            ('recurrence_week_period', self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True, db_index=True, blank=True)),
            ('recurrence_week_rank', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True)),
            ('recurrence_week_parity', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True)),
            ('recurrence_end_date', self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'agenda', ['Event'])

        # Adding unique constraint on 'Event', fields ['exception_to', 'exception_date']
        db.create_unique(u'agenda_event', ['exception_to_id', 'exception_date'])

        # Adding M2M table for field services on 'Event'
        m2m_table_name = db.shorten_name(u'agenda_event_services')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'agenda.event'], null=False)),
        ...
        m2m_table_name = db.shorten_name(u'agenda_event_participants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'agenda.event'], null=False)),
            ('people', models.ForeignKey(orm[u'personnes.people'], null=False))
        ))
        db.create_unique(m2m_table_name, ['event_id', 'people_id'])

        # Adding model 'EventWithAct'
        db.create_table(u'agenda_eventwithact', (
            (u'event_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['agenda.Event'], unique=True, primary_key=True)),
            ('act_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ressources.ActType'])),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dossiers.PatientRecord'])),
            ('convocation_sent', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
        ))
        db.send_create_signal(u'agenda', ['EventWithAct'])


    def backwards(self, orm):
        # Removing unique constraint on 'Event', fields ['exception_to', 'exception_date']
        db.delete_unique(u'agenda_event', ['exception_to_id', 'exception_date'])

        # Deleting model 'EventType'
        db.delete_table(u'agenda_eventtype')

        # Deleting model 'Event'
        db.delete_table(u'agenda_event')

        # Removing M2M table for field services on 'Event'
        db.delete_table(db.shorten_name(u'agenda_event_services'))

        # Removing M2M table for field participants on 'Event'
        db.delete_table(db.shorten_name(u'agenda_event_participants'))

        # Deleting model 'EventWithAct'
        db.delete_table(u'agenda_eventwithact')
