...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.recurrence_week_rank'
        db.alter_column(u'agenda_event', 'recurrence_week_rank', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Event.recurrence_week_rank'
        db.alter_column(u'agenda_event', 'recurrence_week_rank', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
