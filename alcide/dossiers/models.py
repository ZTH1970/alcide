...
from alcide.choices import TYPE_OF_CONTRACT_CHOICES, DEFICIENCY_CHOICES
from alcide.models import PhoneNumberField, ZipCodeField
from alcide.personnes.models import People
from alcide.ressources.models import (ServiceLinkedAbstractModel,
        NamedAbstractModel)
...
logger = logging.getLogger('alcide.dossiers')
...
class PatientRecord(ServiceLinkedAbstractModel, PatientContact):
    ...
    def automated_switch_state(self, modifier):
        ...
        from alcide.facturation import list_acts
