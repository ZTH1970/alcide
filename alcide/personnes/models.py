...
from alcide.models import PhoneNumberField
from alcide.ressources.models import Service, NamedAbstractModel
from alcide.models import (BaseModelMixin, WeekRankField,
