...
from alcide.ressources.urls import ressource_patterns


user_patterns = patterns('alcide.personnes.views',
    url(r'^$', 'user_listing'),
    url(r'^new/$', 'user_new'),
...
holiday_actions_paterns = patterns('alcide.personnes.views',
...
worker_patterns = patterns('alcide.personnes.views',
...
holidays_patterns = patterns('alcide.personnes.views',
...
urlpatterns = patterns('alcide.personnes.views',
    url(r'^$', 'homepage'),
