...
from alcide.actes.validation import automated_validation, \
...
from alcide.dossiers.models import create_patient, PatientRecord, \
    SessadHealthCareNotification, CmppHealthCareTreatment, CmppHealthCareDiagnostic
from alcide.dossiers.models import Status
from alcide.ressources.models import ActType, Service, WorkerType
