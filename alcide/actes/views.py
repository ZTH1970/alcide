...
from alcide.cbv import ListView, UpdateView, DeleteView
from alcide.agenda.views import NewAppointmentView
from alcide.agenda.models import EventWithAct
from alcide.agenda.forms import UpdateAppointmentForm, NewAppointmentForm
